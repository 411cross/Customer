package com.example.peek_mapdemotest.nurseapp.alipayjar;
/**
 * 支付宝功能类
 */
...
public class OrderInfoUtil2_0 {
	...
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2,String Total_Amount,String Subject,String Body) {
		...
		keyValues.put("app_id", app_id);
//total_amount :金额  subject:商品名称  body:商品描述
		//"{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\"0.01\",\"subject\":\"1\",\"body\":\"我是测试数据\",\"out_trade_no\":\"" + getOutTrad//eNo() + "\"}"
